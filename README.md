...
- Webservice monolito com recursos acessados nas formas de `URL's mapeadas em views renderizadas` via **template engine** e endpoints expostos em `JSON` via **REST API** desenvolvido com majoritariamente com **Java e Spring Boot 4 (MVC + REST)**.
